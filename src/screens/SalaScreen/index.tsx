...
import ResponsiveDrawer from "./headerHome";
...
import TemCoxt from "./GetOrganização/TemCoxt";
...
function Sala(props) {
  ...
  const orgs = props.org.organizacoes
  const drawer = (
    <div>
      <Toolbar />
      <Divider />
  ...
  console.log('minhas contas', props.org.organizacoes)
